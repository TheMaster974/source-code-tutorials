...
Scheme
{
	...
	Colors
	{
		...
		"BorderSelection"	"0 0 0 196"			// the additional border color for displaying the default/selected button
...
//		Button.DepressedBgColor			"Blank"
		...
		ScrollBarSlider.FgColor				"ControlDarkBG"			// nob color
		ScrollBarSlider.BgColor				"ControlBG"	// slider background color
