...
ConVar r_flashlight_version2("r_flashlight_version2", "0", FCVAR_CHEAT ); // Changed from extern to fix compilation issue?
...
// ------------------------------------------------------------------------------------------
// I don't know what to do about this, as the DrawFlashlight_dx90_Vars_t struct is
// defined in BaseVSShader.h, in a section of code contained within a #ifndef GAME_SHADER_DLL
// statement. I'll comment it out for now, who knows if this is even needed?
// ------------------------------------------------------------------------------------------
		/*
